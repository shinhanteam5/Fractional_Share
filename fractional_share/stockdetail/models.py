...
class StockDetail(models.Model):
    ...
    profit1 = models.DecimalField(max_digits=20, decimal_places=2,verbose_name='profit1')
    profit2 = models.DecimalField(max_digits=20, decimal_places=2,verbose_name='profit2')
    profit3 = models.DecimalField(max_digits=20, decimal_places=2,verbose_name='profit3')
    
    sales1 = models.DecimalField(max_digits=20, decimal_places=2,verbose_name='sales1')
    sales2 = models.DecimalField(max_digits=20, decimal_places=2,verbose_name='sales2')
    sales3 = models.DecimalField(max_digits=20, decimal_places=2,verbose_name='sales3')
