...
url = 'https://finance.naver.com/item/main.nhn?code=000020'
...
if response.status_code == 200:
    ...
    profit2 = soup.select_one('#content > div.section.cop_analysis > div.sub_section > table > tbody > tr:nth-child(3) > td:nth-child(3)')
